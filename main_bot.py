...
class Satellite_Bot:
    ...
    def calculation_satellite(self):
        ...
        self.plans_noaa15 = self.noaa_15.get_next_passes(self.utc_time, Satellite_Bot.hou, Satellite_Bot.long_poz,  # расчет пролетов
                                                        Satellite_Bot.lat_poz, Satellite_Bot.height_poz, tol=0.001, horizon=Satellite_Bot.pitch)
        self.plans_noaa18 = self.noaa_18.get_next_passes(self.utc_time, Satellite_Bot.hou,
                                                        Satellite_Bot.long_poz, Satellite_Bot.lat_poz, Satellite_Bot.height_poz, tol=0.001, horizon=Satellite_Bot.pitch)
...
print(bot.calculation_satellite())
